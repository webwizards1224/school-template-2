                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-block">
                                                    ...
                                                    ?>
                                                        <form method="post" action="sqlFiles/updateNoticeSQL.php?id=<?php echo $rows['id'] ?>">
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Title</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="title" value='<?php echo $rows['title']; ?>' class="form-control" placeholder="Type your Notice Title">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Description</label>
                                                                <div class="col-sm-10">
                                                                    <textarea id="summernote" class="form-control" name="description"><?php echo $rows['description']; ?></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <select name="status" class="form-control">
                                                                        <option disabled><?php echo $rows['status']; ?></option>
