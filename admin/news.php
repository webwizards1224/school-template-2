                                ...
                                <div class="page-body">
                                    <div class="card">
                                        <div class="card-header d-flex">
                                            <div class="col-md-10">
                                                <h5>News</h5>
                                                <span>Unveiling the Latest Stories: Schools <code>News Hub</code></span>
                                            </div>
                                            <div class="col-md-2">
                                                <a class="btn btn-inverse waves-effect waves-light" href="new-news.php">+ New News</a>
                                            </div>
                                        </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="btn-group " role="group" data-toggle="tooltip" data-placement="top" title="" data-original-title="Actions">
                                                                        <button type="button" class="btn btn-primary btn-md waves-effect waves-light"><a href="edit-news.php?id=<?php echo $rows['id']; ?>">Edit</a></button>
                                                                        <button type="button" class="btn btn-primary btn-md waves-effect waves-light"><a href="edit-news.php?id=<?php echo $rows['id']; ?>">View</a></button>
