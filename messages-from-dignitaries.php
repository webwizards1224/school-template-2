    ...
    <div class="container">
        ...
        <div class="white-sec">
            <div class="container-xxl pt-5">
                <div class="bg-dark-blue rounded row">
                    <div class="col-lg-3 wow fadeIn" data-wow-delay="0.5s">
                        <img class="dignitaries-img" style="border-radius: 100%;" src="assets/img/testimonial-3.jpg">
                    </div>
                    <div class="col-lg-9 wow fadeIn" data-wow-delay="0.5s">
                        <div class="h-100 d-flex flex-column justify-content-center">
                            <h1 class="mb-4 text-white pe-4">MESSAGE FROM TRUSTEE</h1>
                            <p class="mb-4 text-white pe-4">
                                Labore dolor amet ipsum ea, erat sit ipsum duo eos. Volup amet ea dolor et magna dolor,
                                elitr rebum duo est sed diam elitr. Stet elitr stet diam duo eos rebum ipsum diam ipsum
                                elitr.
                                Labore dolor amet ipsum ea, erat sit ipsum duo eos. Volup amet ea dolor et magna dolor,
                                elitr rebum duo est sed diam elitr. Stet elitr stet diam duo eos rebum ipsum diam ipsum
                                elitr.Labore dolor amet ipsum ea, erat sit ipsum duo eos. Volup amet ea dolor et magna
                                dolor, elitr rebum duo est sed diam elitr. Stet elitr stet diam duo eos rebum ipsum diam
                                ipsum elitr.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="bg-light-blue rounded row mt-5">
                    <div class="col-lg-9 wow fadeIn" data-wow-delay="0.5s">
                        <div class="h-100 d-flex flex-column justify-content-center">
                            <h1 class="mb-4 text-white ps-4">MESSAGE FROM PRINCIPLE</h1>
                            <p class="mb-4 text-white ps-4">
                                Labore dolor amet ipsum ea, erat sit ipsum duo eos. Volup amet ea dolor et magna dolor,
                                elitr rebum duo est sed diam elitr. Stet elitr stet diam duo eos rebum ipsum diam ipsum
                                elitr.
                                Labore dolor amet ipsum ea, erat sit ipsum duo eos. Volup amet ea dolor et magna dolor,
                ...
                <div class="bg-dark-blue rounded row mt-5">
                    <div class="col-lg-3 wow fadeIn" data-wow-delay="0.5s">
                        <img class="dignitaries-img" style="border-radius: 100%;" src="assets/img/testimonial-3.jpg">
                    </div>
                    <div class="col-lg-9 wow fadeIn" data-wow-delay="0.5s">
                        <div class="h-100 d-flex flex-column justify-content-center">
                            <h1 class="mb-4 text-white pe-4">MESSAGE FROM VICE-PRINCIPLE</h1>
                            <p class="mb-4 text-white pe-4">
                                Labore dolor amet ipsum ea, erat sit ipsum duo eos. Volup amet ea dolor et magna dolor,
                                elitr rebum duo est sed diam elitr. Stet elitr stet diam duo eos rebum ipsum diam ipsum
                                elitr.
